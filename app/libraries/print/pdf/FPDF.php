...
public function pdf_header_logo()
{
	$logo = FCPATH . "../private/uploads/files/instance_".$_SESSION['User_DB']->instance_id."/".\libraries\Administration::getValue('logo');
	$this->Image($logo, 15, 11, 19, 19);
}

public function pdf_footer_print()
{
	$this->SetY(-15);
  	$this->SetFont('Arial','I',8);
    $this->Cell(0,4,utf8_decode('Fecha de impresión ').date('m/d/Y h:i A'),0,0,'L');
